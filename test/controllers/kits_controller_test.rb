...
class KitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create kit" do
    assert_difference("Kit.count") do
      post kits_url, params: { kit: { button_id: @kit.button_id, fabric_id: @kit.fabric_id, lining_id: @kit.lining_id } }
    end
  ...
  test "should update kit" do
    patch kit_url(@kit), params: { kit: { button_id: @kit.button_id, fabric_id: @kit.fabric_id, lining_id: @kit.lining_id } }
